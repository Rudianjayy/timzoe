...
@section('content')
    ...
    <body>
        <h1 class="text-center mb-4">Tambah Ekstrakulikuler Detail</h1>
        ...
        <div class="container" mb-5>
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/tambahdetail1" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <textarea name="deskripsi_ekstrakulikuler" id="mytextarea">{{ old('deskripsi_ekstrakulikuler') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <a href="/admindetailekstrakulikuler" class="btn btn-danger">Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
