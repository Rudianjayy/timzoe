            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="/tambahfotojurusan" class="btn btn-primary mt-5"
                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/deletefotojurusan/{{ $row->id }}" class="btn btn-danger fas fa-trash-alt" onclick="return confirm('yakin gen?')">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
