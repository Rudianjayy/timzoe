...
@section('content')
    ...
    <body>
        <h1 class="text-center mb-4">Tambah Detail Akademi</h1>
        ...
        <div class="container" mb-5>
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/submitdata7" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="akademis_id" class="form-control" id="jurusan">
                                        <option value=""></option>
                                        @foreach ($akademi as $ami)
                                            <option value="{{ $ami->id }}">{{ $ami->judul_akademi }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('akademis_id')
                  ...
                  @enderror
                                ...
                                <a href="/admindetailakademi" class="btn btn-danger">Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
