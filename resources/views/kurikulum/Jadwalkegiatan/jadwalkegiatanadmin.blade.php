            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="/tambahjadwalkegiatan" class="btn btn-primary mt-5"
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/editjadwalkegiatan/{{ $d->id }}" class="btn btn-warning">Edit</a>

                                            <a href="/deletejadwalkegiatan/{{ $d->id }}" class="btn btn-danger" onclick="return confirm('apakah anda yakin?')">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
