        ...
        <div id="page" class="clearfix">
           ...
           @include('koneksi.navbar')
                        ...
                        <div class="col-md-12">
                            <div class="page-title-inner flex">
                                <div class="page-title-heading">
                                    <h2 class="heading">Kalender Akademik</h2>
                                </div>
            ...
            <div class="text-center">
                <img src="{{ asset('landing/html/bidzend/assets/images/img-collection/kalender.jpg') }}" alt="">
                <img src="{{ asset('landing/html/bidzend/assets/images/img-collection/kalender2.jpg') }}" alt="">
