                                                    ...
                                                    <div class="card-body p-0">
                                                        <div class="widget-content widget-content-area">
                                                            <form action="/updateprofiladmin" method="POST"
                                                                ...
                                                                @csrf
                                                                <h4 style="color: black;">Edit Profil</h4>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="exampleInputEmail1" class="form-label"> Edit
                                                                        Foto :</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="exampleInputEmail1"
                                                                        class="form-label">Edit Foto Background :</label>
                                                                    <input type="file" value="foto_bg" name="foto_bg"
                                                                        class="form-control" id="exampleInputEmail1"
                                                                        aria-describedby="emailHelp">
                                                                    @error('foto_bg')
                                                                        <div class="alert alert-danger">{{ $message }}
