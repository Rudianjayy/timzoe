            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="/tambahdetailakademi" class="btn btn-primary mt-5"
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->akademi ? $row->akademi->judul_akademi : 'Data tidak ada' }}</td>
                                        <td>{!! $row->deskripsi_detail !!}</td>

                                        {{-- <td>{{ $row->created_at->format('D M Y') }}</td> --}}
                                        <td>
                                            {{-- <a href="/editalbum/{{ $row->id }}" class="btn btn-warning fas fa-pen-alt">Edit</a> --}}
                                            <a href="/deletedetailakademi/{{ $row->id }}" class="btn btn-danger fas fa-trash-alt" onclick="return confirm('yakin gen?')">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
