...
<!-- Mirrored from ashik.templatepath.net/inovex-html-files/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Sep 2022 03:21:39 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Home Three || Inovex || Marketing Agency HTML5 Template</title>
    <!-- favicons -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <nav class="main-nav-one main-nav-one__home-three stricky">
            <div class="container-fluid">
                <div class="inner-container">
                    <div class="logo-box">
                        <a href="index.html">
                            <img src="{{ asset('landingppdb/ppdb/style/assets/images/logo-1-2.png') }}"" alt="">
                        </a>
        ...
        <section class="banner-two">
            ...
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/banner-3-shape-1-1.png') }}" class="banner-two__bg-shape-1" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/banner-3-shape-1-2.png') }}" class="banner-two__bg-shape-2" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/banner-3-shape-1-3.png') }}" class="banner-two__bg-shape-3" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/banner-3-shape-1-4.png') }}" class="banner-two__bg-shape-4" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/banner-3-shape-1-5.png') }}" class="banner-two__bg-shape-5" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/banner-3-shape-1-6.png') }}" class="banner-two__bg-shape-6" alt="">

            <div class="container">
                <img src="{{ asset('landingppdb/ppdb/style/assets/images/mocups/banner-moc-3-1.png') }}" class="banner-two__moc" alt="">
                <div class="row">
                    <div class="col-lg-6">
        ...
        <section class="brand-one brand-one__pricing-page brand-one__home-three">
            <div class="container">
                ...
                <div class="brand-one__carousel owl-carousel thm__owl-carousel owl-theme"
                    data-options='{"items": 5, "margin": 95, "smartSpeed": 700, "loop": true, "autoplay": true, "autoplayTimeout": 5000, "autoplayHoverPause": false, "nav": false, "dots": false, "responsive": {"0": { "margin": 20, "items": 2 }, "575": { "margin": 30, "items": 3 },"767": { "margin": 40, "items": 4 },   "991": { "margin": 70, "items": 4 }, "1199": { "margin": 95, "items": 5 } } }'>
                    <div class="item">
                    ...
                    <div class="col-xl-6 d-flex">
                        <div class="my-auto">
                            <div class="service-two__main ">
                                ...
                                <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/service-sign-1-1.png') }}" alt="">
        ...
        <section class="about-one">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/bg-shape-1-1.png') }}" class="error-404__bg-shape-1" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/bg-shape-1-2.png') }}" class="error-404__bg-shape-2" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/bg-shape-1-3.png') }}" class="error-404__bg-shape-3" alt="">
                    ...
                    <div class="col-lg-6 d-flex">
                        <div class="my-auto">
                            <div class="about-one__image wow slideInDown" data-wow-duration="1500ms">
                                <img src="{{ asset('landingppdb/ppdb/style/assets/images/mocups/about-1-moc-1.png') }}" alt="">
        ...
        <section class="service-one service-one__home-three">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/service-1-h3-shape-1.png') }}" class="service-one__home-three__bg-1" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/service-1-h3-shape-2.png') }}" class="service-one__home-three__bg-2" alt="">
            <img src="{{ asset('landingppdb/ppdb/style/assets/images/shapes/service-1-h3-shape-3.png') }}" class="service-one__home-three__bg-3" alt="">
            <div class="container">
                <div class="block-title text-center">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="faq-one__form-image">
                            <img src="{{ asset('landingppdb/ppdb/style/assets/images/mocups/faq-moc-1-1.png') }}" alt="">
                            <img src="{{ asset('landingppdb/ppdb/style/assets/images/mocups/faq-moc-1-2.png') }}" alt="">
            ...
            <div class="container">
                ...
                <div class="thm__owl-carousel blog-one__carousel owl-carousel owl-theme"
                    ...
                    <div class="item">
                        <div class="blog-one__single">
                            <div class="blog-one__image">
                                <img src="{{ asset('landingppdb/ppdb/style/assets/images/blog/blog-1-1.jpg') }}" alt="">
                    ...
                    <div class="item">
                        <div class="blog-one__single">
                            <div class="blog-one__image">
                                <img src="{{ asset('landingppdb/ppdb/style/assets/images/blog/blog-1-2.jpg') }}" alt="">
                                <a href="blog-details.html"><i class="fal fa-plus"></i></a>
                            </div><!-- /.blog-one__image -->
                            <div class="blog-one__content">
                                <div class="blog-one__meta">
...
<!-- Mirrored from ashik.templatepath.net/inovex-html-files/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Sep 2022 03:24:30 GMT -->
</html>
