                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <div class="row">
                                ...
                                <div>
                                    <a href="/tambahfotoslider" class="btn btn-primary mt-2"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data2 as $dd)
                                            <tr>
                                                <th>{{ $no++ }}</th>
                                                <td>
                                                    <img src="{{ asset('fotomahasiswa/' . $dd->foto_slider) }}" alt=""
                                                        style="width: 50px;">
                                                </td>
                                                    ...
                                                    <ul class="table-controls">
                                                        ...
                                                        <li>
                                                            <a href="#" class="delete fire"
                                                                data-id="{{ $dd->id }}"
                                                                data-nama="{{ $dd->foto_slider }}" data-toggle="tooltip"
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletefotoslider/" + id + ""
