...
@section('content')
    ...
    <body>
        <h1 style="color: black;" class="text-center mb-4">Edit Tentang Kami</h1>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/submitedit13/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <textarea name="deskripsi_tentangkami" id="mytextarea">{{ $data->deskripsi_tentangkami }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
