  ...
  <div class="container" mb-5>
      ...
      <div class="row justify-content-center">
        <div class="col-8">
          <div class="card">
            <div class="card-body">
              <form action="/albumproses" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul_album" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                    @error('judul_album')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
