...
<head>
    ...
    <body>
        <h1 class="text-center mb-4">Edit Mikrotik</h1>
                        ...
                        <div class="card-body">
                            <form action="/editproses4/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-solid" rows="6x" name="deskripsi_mikrotik">{{ $data->deskripsi_mikrotik }}</textarea>
