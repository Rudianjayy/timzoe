            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="/tambahfooteer" class="btn btn-primary mt-5"
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td>{!! $d->deskripsi_footeer !!}</td>

                                        {{-- <td>{{ $d->created_at->format('D M Y') }}</td> --}}
                                        <td>
                                            <a href="/editfooteer/{{ $d->id }}" class="btn btn-warning">Edit</a>

                                            <a href="/deletefooteer/{{ $d->id }}" class="btn btn-danger" onclick="return confirm('apakah anda yakin?')">Delete</a>
