...
@section('content')
    ...
    <body>
        <h1 style="color: black;" class="text-center mb-4">Edit Data Akademi </h1>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/submitedit6/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Foto :</label>
                                    <input type="file" name="foto_edotel" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->foto_edotel }}">
                                    <img src="{{ asset('fotomahasiswa/' . $data->foto_edotel) }}" alt="" style="width: 70px">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-solid" name="judul_akademi">{{ $data->judul_akademi }}</textarea>
                                    @error('judul_akademi')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <textarea name="deskripsi_akademi" id="mytextarea">{{ $data->deskripsi_akademi }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
