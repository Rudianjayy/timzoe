    ...
    <section class="team-area pt-100 pb-70">
        <div class="container">
            <div class="section-title">
                <h2>Zoe Team</h2>
                <div class="bar"></div>
                <h5 style="color: red;" >``Sebenar benarnya kita, Pasti tetap SALAH.``</h5>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-team">
                        <div class="image">
                            <img src="{{ asset('admintemp/adminnew/riski/nopan/assets/img/rudi.jpg') }}" alt="image">
                            <ul class="social">
                                <li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team">
                        <div class="image">
                            <img src="{{ asset('admintemp/adminnew/riski/nopan/assets/img/nopan.jpg') }}" alt="image">
                            <ul class="social">
                                <li>
                                ...
                                <li>
                                    <a href="https://www.instagram.com/nouuuvv/saved/" target="_blank">
                                        <i class="fab fa-instagram"></i>
                                    </a>
                                </li>
                                <li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team">
                        <div class="image">
                            <img src="{{ asset('admintemp/adminnew/riski/nopan/assets/img/riski.jpg') }}" alt="image">
                            <ul class="social">
                                <li>
                                    <a href="#" target="_blank">
                                        <i class="fab fa-facebook-f"></i>
