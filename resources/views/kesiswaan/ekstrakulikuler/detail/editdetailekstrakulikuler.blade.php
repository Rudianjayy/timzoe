...
<head>
    ...
    <body>
        <h1 class="text-center mb-4">Edit Detail Ekstrakulikuler</h1>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/editdetail1/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nama Ekstrakulikuler:</label>
                                    <textarea class="form-control form-control-solid" rows="6x" name="nama_ekstrakulikuler">{{ $data->nama_ekstrakulikuler }}</textarea>
