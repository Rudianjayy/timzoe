                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="slider-item">
                                            <div class="sc-author-card">
                                                <div class="card-media">
                                                    <img width="500" height="500" src="{{ asset('landing/html/bidzend/assets/images/logo/ak1.jpg') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="sc-author-card">
                                                <div class="card-media">
                                                    <img width="500" height="500" src="{{ asset('landing/html/bidzend/assets/images/logo/ak2.jpg') }}"
                                                        alt="">
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="sc-author-card">
                                                <div class="card-media">
                                                    <img width="500" height="500" src="{{ asset('landing/html/bidzend/assets/images/logo/ak3.jpeg') }}"
                                                        alt="">
                                                </div>
