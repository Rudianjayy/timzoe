...
<head>
    ...
    <body>
        <h1 style="color: black;" class="text-center mb-4">Edit Footeer</h1>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/editprosesfooter/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <textarea name="deskripsi_footeer" id="mytextarea">{{  $data->deskripsi_footeer }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <button type="submit" class="btn btn-primary mt-3padm">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
