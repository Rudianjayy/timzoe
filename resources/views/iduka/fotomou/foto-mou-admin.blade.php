            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="/tambahfotomou" class="btn btn-primary mt-5"
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/editfotomou/{{ $d->id }}" class="btn btn-warning">Edit</a>

                                            <a href="/deletefotomou/{{ $d->id }}" class="btn btn-danger" onclick="return confirm('yakin gen?')">Delete</a>
