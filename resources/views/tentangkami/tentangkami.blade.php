                    ...
                    <div class="row">
                            ...
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.html"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/profilsekolah.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                        <center>    <h5><a href="/profilsekolah">Profil Sekolah</a></h5></center>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.html"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/identitas.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                        <center>    <h5><a href="/identitas-sekolah">Identitas Sekolah</a></h5></center>
                                    </div>
                                </div>
                            </article>
                        </div>
                            ...
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="/fasilitas"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/fasilitas.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                     <center> <h5><a href="blog-details.html">Fasilitas</a></h5><center>
                                    </div>
                                </div>
                            </article>
                        </div>
