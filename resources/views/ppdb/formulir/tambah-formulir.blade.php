...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css"
            href="{{ asset('admintemp/adminnew/riski/nopan/plugins/jquery-step/jquery.steps.css') }}">
        <link href="{{ asset('admintemp/adminnew/riski/nopan/assets/css/ecommerce/ecommerce-wizards.css') }}" rel="stylesheet"
            type="text/css">
        <link href="{{ asset('admintemp/adminnew/riski/nopan/plugins/sweetalerts/sweetalert2.min.css') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('admintemp/adminnew/riski/nopan/plugins/sweetalerts/sweetalert.css') }}" rel="stylesheet"
            type="text/css" />
    </head>
