                ...
                <div class="page-title">
                    ...
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li><a href="#">UPJ</a></li>
                            <li class="active"><a href="#">Footer Link</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-center">
                                                    <ul class="table-controls">
                                                        <li>
                                                            <a href="/editupjfooterlink/{{ $d9->id }}" data-toggle="tooltip"
                                                        ...
                                                        <li>
                                                            <a href="#" class="delete fire"
                                                                data-id="{{ $d9->id }}"
                                                                data-nama="{{ $d9->nama }}" data-toggle="tooltip"
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deleteupjfooterlink/" + id + ""
