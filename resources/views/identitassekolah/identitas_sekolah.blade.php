...
<body class="body header-fixed">
    ...
    <section class="faq-one">
        <div class="content-center">
            <div class="container-riski" style="margin-left: 277px;">
                <div class="block-title text-center">
                    <h3 style="margin-right: 300px;">Identitas Sekolah</h3>
                    <center><img src="{{ asset('landing/html/bidzend/assets/images/logo/muhi.jpg') }}" alt=""
                            style="width: 200px; height:200px; margin-bottom:20px; margin-right:300px; "></center>
                            ...
                            <div class="accrodion-grp" data-grp-name="career-one__accrodion">
                                <div class="accrodion">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="namasekolah"><i
                                                    class="fas fa-school"></i></label>
                                            <p>{{ $i->namasekolah }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="npsn"><i
                                                    class="far fa-sort-numeric-down-alt"></i></label>
                                            <p>{{ $i->npsn }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="alamat"><i
                                                    class="far fa-map-marker-alt"></i></label>
                                            <p>{{ $i->alamat }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="kecamatan"><i
                                                    class="far fa-location-arrow"></i></label>
                                            <p>{{ $i->kecamatan }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="fax"><i
                                                    class="fas fa-phone-office"></i></label>
                                            <p>{{ $i->fax }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="accrodion-grp" data-grp-name="career-one__accrodion-2">
                                <div class="accrodion ">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="kabupaten"><i
                                                    class="fas fa-city"></i></label>
                                            <p>{{ $i->kabupaten }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="provinsi"><i
                                                    class="fas fa-location"></i></label>
                                            <p>{{ $i->provinsi }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="kodepos"><i
                                                    class="far fa-mailbox"></i></label>
                                            <p>{{ $i->kodepos }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <label for="" class="telepon"><i
                                                    class="fas fa-phone-square-alt"></i></label>
                                            <p>{{ $i->telepon }}</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
