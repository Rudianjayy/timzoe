...
<body>
  <h1 class="text-center mb-4">Tambah BSI</h1>
  ...
  <div class="container" mb-5>
      ...
      <div class="row justify-content-center">
        <div class="col-8">
          <div class="card">
            <div class="card-body">
              <form action="/submitdata8" method="POST" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        {{--  <form method="POST" enctype="multipart/form-data">  --}}
                                            <textarea name="deskripsi_bsi" id="mytextarea" value="deskripsi_iduka"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
