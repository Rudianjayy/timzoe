...
<body>
  <h1 style="color: black;" class="text-center mb-4">Edit UPJ</h1>
  ...
  <div class="container" mb-5>
      ...
      <div class="row justify-content-center">
        <div class="col-8">
          <div class="card">
            <div class="card-body">
              <form action="/editupjproses/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            <textarea name="judul1" id="mytextarea">{{ $data->judul1 }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            <textarea name="judul2" id="mytextarea">{{ $data->judul2 }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            <textarea name="judul3" id="mytextarea">{{ $data->judul3 }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
