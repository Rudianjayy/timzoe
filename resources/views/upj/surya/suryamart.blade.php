                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="blog-details__main">
                                ...
                                <div class="blog-two__meta">
                                    ...
                                    <span>-</span> --}}
                                    <a href="blog-details.html">Diterbitkan :{{ $sm->created_at }}</a>
                                </div><!-- /.blog-two__meta -->
                                <center><img src="{{ asset('fotomahasiswa/' . $sm->foto_surya) }}" class="img-fluid" alt="" style="width:650px; height:352px;"></center>
                                {{-- <h3>Additional Services that will <br> Grow Business</h3> --}}
                                <p>{!! $sm->deskripsi_surya !!} </p>
