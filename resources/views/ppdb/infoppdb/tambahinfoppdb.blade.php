...
@section('content')
    ...
    <body>
        <h1 style="color: black" class="text-center mb-4">Tambah Info PPDB</h1>
        ...
        <div class="container" mb-5>
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/prosestambahinfoppdb" method="POST" enctype="multipart/form-data">
                                @csrf
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        {{--  <form method="POST" enctype="multipart/form-data">  --}}
                                                            <textarea name="deskripsi_infoppdb" id="mytextarea" value="deskripsi_infoppdb"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
