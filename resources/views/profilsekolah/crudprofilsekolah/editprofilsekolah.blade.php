          ...
          <div class="card">
            <div class="card-body">
              <form action="/editprosessekolah/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Deskripsi lanjutan :</label>
                    <textarea class="form-control form-control-solid" name="deskripsi_lanjutan">{{ $data->deskripsi }}</textarea>
                  ...
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Foto :</label>
                    <input type="file" name="foto_simuhi" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->foto_simuhi }}">
                    <img src="{{ asset('fotomahasiswa/' . $data->foto_simuhi) }}" alt="" style="width: 70px">
                ...
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Deskripsi Simuhi :</label>
                  <textarea class="form-control form-control-solid" name="deskripsi_simuhi">{{ $data->deskripsi_simuhi }}</textarea>
                  @error('deskripsi_simuhi')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
