                        ...
                        <div class="col-md-12">
                            <div class="sc-heading style-2">
                                <div class="content-left">
                                    <div class="inner">
                                        <h3>Pengembangan Perangkat Lunak & Game (PPLG)</h3>
                                        ...
                                        <div class="slider-item">
                                            <div class="sc-author-card">
                                                <div class="card-media">
                                                    <img width="500" height="500" src="{{ asset('landing/html/bidzend/assets/images/logo/rpl1.jpeg') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
