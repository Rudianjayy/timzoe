...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/utilities/search/users.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Sep 2022 08:20:24 GMT -->
...
<head>
		...
		<link href="{{ asset('template/nopan/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css" />
		<!--end::Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->
		<link href="{{ asset('template/nopan/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-header" data-kt-app-header-fixed="true" data-kt-app-toolbar-enabled="true" class="app-default">
						...
						<div id="kt_app_footer" class="app-footer">
							...
							<div class="app-container container-xxl d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
								...
								<div class="text-dark order-2 order-md-1">
									<span class="text-muted fw-semibold me-1">2022&copy;</span>at SMK Muhammadiyah 1 Genteng supported by Team Zoe</a>
								</div>
								<!--end::Copyright-->
								<!--begin::Menu-->
						...
						<form class="form" method="POST" id="kt_app_layout_builder_form" action="https://preview.keenthemes.com/metronic8/demo1/index.php">
							...
							<div class="card-body p-0">
								...
								<div class="form-group">
									...
									<div class="d-flex">
										<!--begin::Check-->
										<div class="form-check form-check-custom form-check-success form-check-solid form-check-sm me-5" data-bs-toggle="tooltip" title="This option is not supported in current layout">
											<input class="form-check-input" type="radio" checked="checked" disabled="disabled" value="svg" id="kt_builder_icon_svg" name="layout-builder[layout][app][sidebar][default][menu][icon-type]" />
											<!--begin::Label-->
										...
										<!--begin::Check-->
										<div class="form-check form-check-custom form-check-success form-check-solid form-check-sm me-5" data-bs-toggle="tooltip" title="This option is not supported in current layout">
											<input class="form-check-input" type="radio" disabled="disabled" value="font" id="kt_builder_icon_font" name="layout-builder[layout][app][sidebar][default][menu][icon-type]" />
											<!--begin::Label-->
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="/metronic8/demo1/../demo1/apps/projects/project.html" class="w-30px me-3" src="{{ asset('template/nopan/assets/media/svg/files/css.svg') }}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
		...
		<!--end::Modals-->
		<!--begin::Javascript-->
		<script>var hostUrl = "{{ asset('template/nopan/') }}assets/index.html";</script>
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/utilities/search/users.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Sep 2022 08:20:25 GMT -->
</html>