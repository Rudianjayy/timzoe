                    ...
                    <article class="sc-card-article">
                        <div class="card-media">
                                ...
                                <div class="content">
                                    ...
                                    <div class="text-article">
                                        <center>    <h5><a href="/profilsekolah">Ekstrakulikuler</a></h5></center>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.html"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/mikrotik.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                        <center>    <h5><a href="/identitas-sekolah">Mkrotik Akademi</a></h5></center>
                                    </div>
                                </div>
                            </article>
                        </div>
                            ...
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="/fasilitas"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/ipm.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                     <center> <h5><a href="blog-details.html">IPM/OSIS</a></h5><center>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="/fasilitas"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/alumni.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                     <center> <h5><a href="blog-details.html">Alumni</a></h5><center>
                                    </div>
                                </div>
                            </article>
                        </div>
