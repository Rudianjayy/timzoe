...
! function(e) {
    ...
    var i = n(6),
        ...
        l = function e(t, n, l) {
            var p, u, f, d, g = t & e.F,
                ...
                v = t & e.P,
                m = t & e.B,
                w = h ? i : b ? i[n] || (i[n] = {}) : (i[n] || {})[c],
                y = h ? o : o[n] || (o[n] = {}),
                x = y[c] || (y[c] = {});
            h && (l = n);
            for (p in l) u = !g && w && void 0 !== w[p], f = (u ? w : l)[p], d = m && u ? s(f, i) : v && "function" == typeof f ? s(Function.call, f) : f, w && a(w, p, f, t & e.U), y[p] != f && r(y, p, d), v && x[p] != f && (x[p] = f)
        };
    ...
    e.exports = !c || n(14)(function() {
        ...
        for (var n = a(e), c = arguments.length, l = 1, p = o.f, u = r.f; c > l;)
            for (var f, d = s(arguments[l++]), g = p ? i(d).concat(p(d)) : i(d), h = g.length, b = 0; h > b;) u.call(d, f = g[b++]) && (n[f] = d[f]);
        return n
    } : c
}, function(e, t, n) {
    var i = n(28),
    ...
    e.exports = function(e, t) {
        ...
        return function(t, s, g) {
            for (var h, b, v = r(t), m = o(v), w = i(s, g, 3), y = a(m.length), x = 0, C = n ? d(t, y) : c ? d(t, 0) : void 0; y > x; x++)
    ...
    var i = n(53),
        ...
        a = n(58),
        s = "eapps.Platform",
        c = /https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,4}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/,
        l = function(e, t, n) {
            var l, p = this,
                u = {},
                f = [],
            ...
            p.initialize = function() {
                p.logError = r.withModule(s), i(function() {
                    t = t || e.document.body, p.establishPreconnections(), p.observe(), p.collectWidgets(t), p.boot(), p.watchWidgetReset()
                })
            }, p.establishPreconnections = function() {
                p.preconnect(p.getPlatformUrl()), p.preconnect("https://static.elfsight.com"), p.preconnect("https://service-reviews-ultimate.elfsight.com"), p.preconnect("https://storage.elfsight.com")
            }, p.preconnect = function(e) {
                var t = document.createElement("link");
                t.href = e, t.rel = "preconnect", t.crossOrigin = "", document.head.appendChild(t)
            }, p.facade = function() {
                return new a(p)
            }, p.requireWidget = function(e) {
                "string" != typeof e && p.logError("Widget Public ID required and should be a string", {
                    pid: e
                }), ~f.indexOf(e) || f.push(e)
            }, p.addPlaceholder = function(e) {
                ~d.indexOf(e) || d.push(e)
            }, p.getEappsClass = function(e) {
                var t = e.className.split(" ");
                return 1 === t.length ? e.className : t.length > 1 ? (t.filter(function(e) {
                    return /elfsight-app-[\S]+/.test(e)
                }), t[0]) : void 0
            }, p.getWidgetIdByElement = function(e) {
                return "div" === e.tagName.toLowerCase() ? p.getEappsClass(e).replace("elfsight-app-", "") : e.getAttribute("data-id")
            }, p.getLazyMode = function(e) {
                var t = "data-elfsight-app-lazy";
                if (!e.hasAttribute(t)) return "disabled";
                var n = e.getAttribute(t);
                return "first-activity" === n || "disabled" === n ? n : "enabled"
            }, p.getWidgetsElements = function(e) {
            ...
            }, p.collectWidgets = function(e) {
                p.getWidgetsElements(e).forEach(function(e) {
                    var t = p.getWidgetIdByElement(e);
                    if (t) {
                        var n = p.getLazyMode(e);
                        if ("disabled" !== n) {
                            var i = "first-activity" === n;
                            p.bootWidgetDeferredly(e, t, i)
                        } else p.requireWidget(t);
                        p.addPlaceholder(e)
                    }
                })
            }, p.bootWidgetDeferredly = function(e, t, n) {
                function i(e) {
                    o(), p.requireWidget(t), p.revise()
                }

                function o() {
                    r && r.disconnect(), a.forEach(function(e) {
                        window.removeEventListener(e, i, s)
                    })
                }
                var r, a = ["scroll", "mousemove", "touchstart", "keydown", "click"],
                    s = {
                        capture: !0,
                        passive: !0
                    },
                    c = !n;
                c && "IntersectionObserver" in window && (r = new IntersectionObserver(function(e) {
                    for (var t = 0; t < e.length; ++t)
                        if (e[t].isIntersecting) {
                            i(e[t]);
                            break
                        }
                })), r && r.observe(e), a.forEach(function(e) {
                    window.addEventListener(e, i, s)
                })
            }, p.watchWidgetReset = function() {
                window.addEventListener("message", function(e) {
                    var t = e.data;
                    t.action && "EappsPlatform.widgetReset" === t.action && p.resetWidget(t.widgetId)
                })
            }, p.resetWidget = function(e) {
                var t = function e(t) {
                    var e = document.createElement("div");
                    return e.className = "elfsight-app-" + t, e
                };
                p.getWidgetsElements().forEach(function(n) {
                    p.getWidgetIdByElement(n) === e && (delete u[e], n.parentNode.replaceChild(t(e), n))
                })
            }, p.initWidget = function(e) {
                var t = p.getWidgetIdByElement(e),
                    i = u[t];
                if (i) {
                    if (!i.status || !i.data) return void p.logError('Widget "' + t + '" can`t be initialized because ' + i.reason, e);
                    i.data.id = t, i.data.platform = !0, i.user && (i.data.isOwner = i.user.owner), n.initWidget(e, i.data)
                }
            }, p.boot = function(e, t) {
                var n = t || f;
                if (n.length) {
                    ...
                    i.open("get", r + "?" + a), i.withCredentials = !0, i.onload = function() {
                        var t = JSON.parse(i.response);
                        t.status || p.logError("Boot failed because " + t.reason, t.data), u = Object.assign({}, u, t.data.widgets), p.loadAssets(t.data.assets), d.forEach(p.initWidget.bind(p)), e && e()
                    }, i.send()
                }
            }, p.getPage = function() {
                try {
                    var e = document.location.href;
                    if (c.test(e)) return new URL(e).toString()
                } catch (e) {}
            }, p.getPlatformUrl = function() {
                return e.eappsCustomPlatformUrl ? e.eappsCustomPlatformUrl : p.useServiceCore() ? "https://core.service.elfsight.com" : "https://apps.elfsight.com"
            }, p.useServiceCore = function() {
                return !!document.querySelector("script[data-use-service-core]")
            }, p.revise = function() {
                var e = f.filter(function(e) {
                    return !(e in u)
                });
                e.length > 0 ? p.boot(null, e) : d.forEach(p.initWidget.bind(p))
            }, p.loadAssets = function(t) {
                t && t.length && t.filter(function(e) {
                    return g.indexOf(e) === -1
                }).forEach(function(t) {
                    var n = e.document.createElement("script");
                    n.src = t, n.setAttribute("defer", "defer"), n.setAttribute("charset", "UTF-8"), e.document.head.appendChild(n), g.push(t)
                })
            }, p.observe = function() {
                if (e.MutationObserver && !l) {
                    var t = {
                            childList: !0,
                            subtree: !0,
                            characterData: !0
                    ...
                    l = new MutationObserver(function(e) {
                        var t = function(e) {
                            p.requireWidget(p.getWidgetIdByElement(e)), p.addPlaceholder(e)
                        };
                        e.forEach(function(e) {
                            var i = function(e) {
                                var i = p.getWidgetsElements(e);
            ...
            n.initialize = function() {
                ...
                if (i) {
                    ...
                    var a = {
                        ...
                        deactivatedWidgetUrl: r.preferences.deactivated_widget_url || null,
                        widgetId: r.id || null,
                ...
                e.classList.add("eapps-widget", "eapps-widget-show-toolbar"), e.appendChild(i)
    ...
    function l(e, t) {
        ...
        if (t.singleton) {
            var r = m++;
            n = v || (v = s(t)), i = p.bind(null, n, r, !1), o = p.bind(null, n, r, !0)
