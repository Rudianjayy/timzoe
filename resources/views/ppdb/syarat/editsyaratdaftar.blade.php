        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/editprosesdaftar/{{ $data2->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Syarat Daftar :</label>
                                    <input type="text" name="deskripsi" class="form-control" value="{{ $data2->deskripsi }}">
                                    @error('deskripsi')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-solid" name="deskripsi_detail">{{ $data2->deskripsi_detail }}</textarea>
