                                ...
                                <tr>
                                    ...
                                    <td class="align-center">
                                        <ul class="table-controls">
                                            <li>
                                                <a href="/editkalenderakademik/{{ $d->id }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="flaticon-edit"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="/delete/{{ $d->id }}" data-toggle="tooltip" data-placement="top" title="Delete">
