        ...
        <div class="container" mb-5>
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/submitdata18" method="POST" enctype="multipart/form-data">
                                @csrf


                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Foto :</label>
                                    <input type="file" name="foto_galery" class="form-control" id="exampleInputEmail1"
                                ...
                                <a href="/admingalery" class="btn btn-danger">Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
