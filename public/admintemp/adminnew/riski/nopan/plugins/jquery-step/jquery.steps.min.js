...
! function(a, b) {
    ...
    function D(a, b, c) {
        if (b.enablePagination) {
            var d = a.find(".actions a[href$='#Kirim']").parent(),
                e = a.find(".actions a[href$='#Selanjutnya']").parent();
            if (!b.forceMoveForward) {
                var f = a.find(".actions a[href$='#Sebelumnya']").parent();
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                ...
                f = "";
            b.forceMoveForward || (f += e.format("Sebelumnya", b.labels.Sebelumnya)), f += e.format("Selanjutnya", b.labels.Selanjutnya), b.enableFinishButton && (f += e.format("Kirim", b.labels.Kirim)), b.enableCancelButton && (f += e.format("cancel", b.labels.cancel)), a.append(d.format(b.actionContainerTag, b.clearFixCssClass, b.labels.pagination, f)), D(a, b, c), A(a, b, c)
        }
    }
