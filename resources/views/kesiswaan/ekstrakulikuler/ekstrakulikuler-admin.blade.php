                ...
                <div class="page-title">
                    ...
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="active"><a href="#">ekstrakurikuler</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <div class="row">
                                ...
                                <div>
                                    <a href="/tambahekstrakulikuler" class="btn btn-primary mt-2"
                                ...
                                <table id="ecommerce-product-list" class="table  table-bordered">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">#</th>
                                            <th scope="col">judul ekstrakulikuler</th>
                                            <th scope="col">Foto </th>
                                            <th scope="col">Deskripsi ekstrakulikuler</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-center">
                                                    <ul class="table-controls">
                                                        <li>
                                                            <a href="/editekstrakulikuler/{{ $d->id }}"
                                                        ...
                                                        <li>
                                                            <a href="#" class="delete fire"
                                                                data-id="{{ $d->id }}"
                                                                data-nama="{{ $d->judul_ekstra }}" data-toggle="tooltip"
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deleteekstra/" + id + ""
