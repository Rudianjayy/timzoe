                    ...
                    <div class="row">
                            ...
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.html"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/upj.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                        <center>    <h5><a href="/profilsekolah">UPJ TKJ</a></h5></center>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.html"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/bsi.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                        <center>    <h5><a href="/identitas-sekolah">Bank Mini Sekolah(BSI)</a></h5></center>
                                    </div>
                                </div>
                            </article>
                        </div>
                            ...
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="/fasilitas"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/muhiprinting.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                     <center> <h5><a href="blog-details.html">Muhi Printing</a></h5><center>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="/fasilitas"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/pegadaian.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                     <center> <h5><a href="blog-details.html">Pegadaian</a></h5><center>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="/fasilitas"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/suryamart.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                     <center> <h5><a href="blog-details.html">Surya Mart</a></h5><center>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="/fasilitas"><img
                                            src="{{ asset('landing/html/bidzend/assets/images/logo/edotel.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <div class="meta-info">
                                    ...
                                    <div class="text-article">
                                     <center> <h5><a href="blog-details.html">EDOTEL</a></h5><center>
                                    </div>
                                </div>
                            </article>
                        </div>
