                    ...
                    <div class="my-auto">
                        <div class="service-two__main ">
                            <div class="block-title text-left">
                                <h3> Apa Itu UPJ TEKAJE</h3>
                            </div><!-- /.block-title text-center -->
                            <p>UPJ TEKAJE (Unit Produksi dan Jasa Teknik Komputer dan Jaringan) adalah Unit produksi milik SMK Muhammadiyah 1 Genteng yang merupakan salah satu Produk unggulan dibidang Teknologi yang dapat bersaing dengan usaha sejenis dikelasnya. Unit produksi juga merupakan salah satu sumber atau sarana belajar yang tepat bagi siswa terutama pada aspek keterampilan untuk menghasilkan produk maupun jasa. Unit Produksi dan Jasa Teknik Komputer dan Jaringan disiapkan oleh guru dan dikelola bersama siswa untuk mengembangkan semua unsur yang relevan, sehingga orang luas tertarik untuk menjalin kerjasama.</p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-one__content">
                        ...
                        <p>Kami Memiliki Jasa Untuk Memudahkan Anda Menyelesaikan Masalah</p>
                        <div class="about-one__box-wrapper">
                            ...
                            <div class="about-one__box">
                                ...
                                <div class="about-one__box-content">
                                    ...
                                    <!-- <p>UPJ TEKAJE memberikan layanan jasa pemasangan Wifi yang dilakukan oleh tenaga teknisi yang perpengalaman dibidangnya, kualitas terjamin dan bergaransi.</p> -->
                                </div><!-- /.about-one__box-content -->
                            </div><!-- /.about-one__box -->
                            <div class="about-one__box">
                                <div class="about-one__box-icon">
                            ...
                            <div class="about-one__box">
                                ...
                                <div class="about-one__box-content">
                                    ...
                                    <!-- <p>UPJ TEKAJE Menerima jasa pembuatan aplikasi berbasis web (Sistem Informasi, Undangan Digital, Iklan Digital, Dll) atau berbasis android yang sesuai dengan kebutuhan anda dengan kualitas terjamin dan bergaransi.</p> -->
                                </div><!-- /.about-one__box-content -->
                            </div><!-- /.about-one__box -->
                            <br>
                            <br>
