            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="/tambahsuryamart" class="btn btn-primary mt-5"
                            ...
                            <tbody>
                                ...
                                @foreach ($data4 as $d4)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/editsuryamart/{{ $d4->id }}" class="btn btn-warning">Edit</a>

                                            <a href="/deletesuryamart/{{ $d4->id }}" class="btn btn-danger" onclick="return confirm('yakin gen?')">Delete</a>
