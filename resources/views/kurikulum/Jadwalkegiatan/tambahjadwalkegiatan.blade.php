...
<body>
  <h1 style="color: black;" class="text-center mb-4">Tambah Jadwal Kegiatan</h1>
  ...
  <div class="container" mb-5>
      ...
      <div class="row justify-content-center">
        <div class="col-8">
          <div class="card">
            <div class="card-body">
              <form action="/jadwalkegiatanproses" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <a href="/jadwalkegiatanadmin" class="btn btn-danger">Kembali</a>
              </form>
            </div>
          </div>
        </div>
