            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{--  <div>
                            <a href="/tambahmuhiprint" class="btn btn-primary mt-5"
                            ...
                            <tbody>
                                ...
                                @foreach ($data2 as $d2)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/editmuhiprint/{{ $d2->id }}" class="btn btn-warning">Edit</a>

                                            {{--  <a href="/deletemuhiprint/{{ $d2->id }}" class="btn btn-danger" onclick="return confirm('yakin gen?')">Delete</a>  --}}
