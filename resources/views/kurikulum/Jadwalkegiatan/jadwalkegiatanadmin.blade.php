            ...
            <div class="page-title">
                ...
                <div class="crumbs">
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="active"><a href="#">Jadwal Kegiatan</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div class="row">
                            ...
                            <div>
                                <a href="/tambahjadwalkegiatan" class="btn btn-primary " id="kt_account_profile_details_submit"
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                    ...
                    text: "Kamu akan menghapus data dengan jadwalkegiatan  " + nama + "! ",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletejadwalkegiatan/" + id + ""
